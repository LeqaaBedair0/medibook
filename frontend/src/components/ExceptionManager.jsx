...
function ExceptionManager({ isOpen, onClose, exceptions, onUpdate, doctorId, allClinics }) {
  ...
  const handleAddException = async () => {
    try {
      ...
      const response = await fetch(`https://mediibook.duckdns.org/api/doctor/${doctorId}/exceptions`, {
        method: 'POST',
  ...
  const handleDeleteException = async (exceptionId) => {
    ...
    try {
      const response = await fetch(`https://mediibook.duckdns.org/api/doctor/${doctorId}/exceptions/${exceptionId}`, {
        method: 'DELETE'
      });
