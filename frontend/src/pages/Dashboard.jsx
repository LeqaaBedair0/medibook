...
function Dashboard({ currentUser }) {
  ...
  const fetchAllClinics = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/manager/clinics`);
  ...
  const fetchStats = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/doctor/${currentUser.id}/quick-stats`);
      const data = await response.json();
      if (response.ok) {
        setStats(data);
  ...
  const fetchTodayAppointments = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/doctor/${currentUser.id}/appointments/today`);
      const data = await response.json();
      if (response.ok) {
  ...
  const fetchWeeklySchedule = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/doctor/${currentUser.id}/clinics`);
      const data = await response.json();
          ...
          data.map(async (clinic) => {
            try {
              const scheduleResponse = await fetch(
                `http://localhost:5000/api/doctor/${currentUser.id}/clinics/${clinic._id}/weekly-schedule`
              );
  ...
  const fetchExceptions = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/doctor/${currentUser.id}/exceptions`);
      const data = await response.json();
      if (response.ok) {
  ...
  const fetchAvailableSlots = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/doctor/${currentUser.id}/available-slots`);
      const data = await response.json();
      if (response.ok) {
  ...
  const fetchAllAppointments = async (page = 1) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/doctor/${currentUser.id}/all-appointments?${params}`
      );
      const data = await response.json();
  ...
  const handleDeleteAvailableSlot = async (slotId) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/doctor/${currentUser.id}/available-slots/${slotId}`, {
        method: 'DELETE'
      });
